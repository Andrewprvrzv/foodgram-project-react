    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=254, unique=True, validators=[django.core.validators.RegexValidator('^[\\w.@+-]+\\z', message='Недопустимое имя.')])),
                ('email', models.EmailField(help_text='Введите свой электронный адрес', max_length=254, unique=True, verbose_name='Адрес электронной почты')),
