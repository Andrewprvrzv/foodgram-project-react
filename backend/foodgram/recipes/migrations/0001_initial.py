    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Выберите ингредиент', max_length=200, unique=True, verbose_name='Наименование ингредиента')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(help_text='Slug тэга', max_length=200, unique=True, validators=[django.core.validators.RegexValidator('^[\\w.@+-]+\\z', message='Недопустимое имя.')], verbose_name='Слаг тэга')),
            ],
        ),
        migrations.CreateModel(
            name='ShoppingCart',
